...
-- Tiempo de generación: 18-04-2026 a las 17:42:35
...
CREATE TABLE `agreements` (
  ...
  `type` enum('contract','credit') NOT NULL,
...
CREATE TABLE `agreement_details` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `agreement_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE `cash_closes` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `isle_id` bigint(20) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `measurements` (
  `id` int(11) NOT NULL,
  `location_id` bigint(20) UNSIGNED NOT NULL COMMENT 'auxiliar, siempre debe ser igual al producto del tanque',
...
CREATE TABLE `payments` (
  ...
  `voucher_id` varchar(30) DEFAULT NULL,
...
CREATE TABLE `products` (
  ...
  `measurement_unit` enum('galones','litros') NOT NULL DEFAULT 'galones',
...
CREATE TABLE `pumps` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(100) NOT NULL,
  `isle_id` bigint(20) UNSIGNED NOT NULL,
  `product_id` bigint(20) UNSIGNED NOT NULL,
  `side` int(11) NOT NULL DEFAULT 1 COMMENT 'lado 1 o 2',
  `deleted` tinyint(1) UNSIGNED NOT NULL DEFAULT 0
...
CREATE TABLE `purchases` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `voucher_type` tinyint(1) UNSIGNED DEFAULT NULL COMMENT '1: Factura , 2:Boleta , 3:Nota de Venta, 4: Otro',
...
CREATE TABLE `purchase_details` (
  ...
  `measurement_unit` enum('galones','litros') NOT NULL,
...
CREATE TABLE `sales` (
  ...
  `date` datetime NOT NULL,
  `type_sale` tinyint(4) NOT NULL COMMENT '0: directa, 1: contratos, 2:creditos',
  `deleted` tinyint(1) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `sale_details` (
  ...
  `truck_id` bigint(20) UNSIGNED DEFAULT NULL,
  `closing_number` tinyint(3) UNSIGNED DEFAULT NULL,
  `quantity` decimal(10,3) NOT NULL,
  `unit_price` decimal(10,2) NOT NULL,
...
CREATE TABLE `stock_balances` (
  `id` int(11) NOT NULL,
  `tank_id` bigint(20) UNSIGNED NOT NULL,
  `product_id` bigint(20) UNSIGNED NOT NULL COMMENT 'auxiliar, siempre debe ser igual al producto del tanque',
  `date` date NOT NULL,
...
CREATE TABLE `transactions` (
  ...
  `location_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `isle_id` bigint(20) UNSIGNED DEFAULT NULL,
  `type` enum('scc','sb','eb') NOT NULL COMMENT 'scc: Salida Caja Chica, sb: Salida Boveda, eb: Entrada Boveda',
...
CREATE TABLE `transfers` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `from_tank_id` bigint(20) UNSIGNED NOT NULL,
  `to_tank_id` bigint(20) UNSIGNED NOT NULL,
  `product_id` bigint(20) UNSIGNED NOT NULL,
  `quantity` decimal(10,3) UNSIGNED NOT NULL,
  `date` datetime NOT NULL,
...
CREATE TABLE `wastes` (
  ...
  `type` enum('serafin','compras','error') NOT NULL COMMENT 'mediciones de serafín, verificacion de compras, errores de surtidora',
  `product_id` bigint(20) UNSIGNED NOT NULL,
  `location_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
ALTER TABLE `cash_closes`
  ADD CONSTRAINT `FK_cash_close_locations` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_cash_closes_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `employees`
  ADD CONSTRAINT `FK_employees_locations` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `isles`
--
ALTER TABLE `isles`
  ADD CONSTRAINT `FK_isle_locations` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `measurements`
--
ALTER TABLE `measurements`
  ADD CONSTRAINT `FK_measurements_locations` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `payments`
  ...
  ADD CONSTRAINT `fk_client_payment` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  ADD CONSTRAINT `fk_user_payment` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `pumps`
--
ALTER TABLE `pumps`
  ADD CONSTRAINT `FK_pump_isle` FOREIGN KEY (`isle_id`) REFERENCES `isles` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_pumps_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `purchase_details`
  ADD CONSTRAINT `FK_purchase_details_tanks` FOREIGN KEY (`tank_id`) REFERENCES `tanks` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `sale_details`
  ADD CONSTRAINT `FK_sale_details_order_details` FOREIGN KEY (`order_detail_id`) REFERENCES `order_details` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_sale_details_pumps` FOREIGN KEY (`pump_id`) REFERENCES `pumps` (`id`) ON DELETE NO ACTION,
  ADD CONSTRAINT `FK_sale_details_trucks` FOREIGN KEY (`truck_id`) REFERENCES `trucks` (`id`) ON DELETE NO ACTION,
...
--
ALTER TABLE `stock_balances`
  ADD CONSTRAINT `fk_balance_product_id` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_balance_tank_id` FOREIGN KEY (`tank_id`) REFERENCES `tanks` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `FK_expenses_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_transactions_locations` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `FK_users_employees` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `wastes`
  ADD CONSTRAINT `FK_wastes_locations` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_wastes_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
